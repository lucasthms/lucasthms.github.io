...
const aircrashes = 'https://raw.githubusercontent.com/lucasthms/aircrashes-dataset/main/data.geojson'
    ...
    map.on('click', 'point', (e) => {
        ...
        document.getElementById('lieu').innerHTML ="<h2>Lieu du crash : </h2>" + city
        var année = e.features[0].properties.annee;
